...
public class MouseHoverPage extends BasePageObject {
    ...
    public void verify_general_info_for_user(int user_num) {
        ...
        Assert.assertTrue(is_username_displayed);
        switch (user_num) {
            case 1:
                Assert.assertEquals(actual_user_name_displayed, USER_01_NAME);
                break;
            case 2:
                Assert.assertEquals(actual_user_name_displayed, USER_02_NAME);
                break;
            case 3:
                Assert.assertEquals(actual_user_name_displayed, USER_03_NAME);
                break;
        }
